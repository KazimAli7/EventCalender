...
import { LOGIN_USER, SET_EMAIL, SET_PASSWORD } from '../../redux/reducers/AuthReducer';
...
function Login() {
  ...
  const { loggedIn, authError } = useSelector((state: any) => state.notify);
  ...
  const handleSubmit = (evt: FormEvent<HTMLFormElement>) => {
    ...
    dispatch(LOGIN_USER(crediential));
  };
